...
class CaronaDAO
{
    ...
    const QUERY_INSERIR_REGRAS = "insert into public.regras (chat_id, message) values (:chat_id, :message) ON CONFLICT (chat_id) DO UPDATE SET chat_id = :message_update";
