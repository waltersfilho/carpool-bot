<?php 
    ...
    class CaronaDAO{
        ...
        const QUERY_REMOVE_EXPIRED_CARPOOLS = "delete from public.caroneiros where travel_hour + (30 ||' minutes')::interval < now() - (3 || 'hours')::interval";
